...
def test_legacy_exact_filename_fallback_backfills_source_id_without_fuzzy_match():
    ...
    api.find_book_by_filename.assert_not_called()
    api.db.update_book_if_exists.assert_called_once_with(book)
